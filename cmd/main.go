...
var (
	...
	errTriggerSecretNameEmpty = errors.New("TRIGGER_SECRET_NAME is empty")
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5c376fa0.furonverse.com",
	...
	triggerSecretName := os.Getenv("TRIGGER_SECRET_NAME")
	if triggerSecretName == "" {
		setupLog.Error(errTriggerSecretNameEmpty, "")
		os.Exit(1)
	}
